...
#  define SDL2_GFXPRIMITIVES_SCOPE extern
	...
	SDL2_GFXPRIMITIVES_SCOPE int texturedPolygon2(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, SDL_Texture * texture, int texture_dx, int texture_dy, int w, int h);
	...
	SDL2_GFXPRIMITIVES_SCOPE int primitivePurge(void);
