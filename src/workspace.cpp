...
#	ifndef WORKSPACE_BAKE_INPUT_CHARACTER_OBSOLETE_FRAME_COUNT
#		define WORKSPACE_BAKE_INPUT_CHARACTER_OBSOLETE_FRAME_COUNT 15
#	endif /* WORKSPACE_BAKE_INPUT_CHARACTER_OBSOLETE_FRAME_COUNT */
	...
	if (result) {
		...
		InputCharacter::Array::iterator it = std::find_if(
			...
			[currentFrame = bakeFrame()] (const InputCharacter &ich) -> bool {
				return ich.frame + WORKSPACE_BAKE_INPUT_CHARACTER_OBSOLETE_FRAME_COUNT < currentFrame;
			}
		);
