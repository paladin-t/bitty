...
public:
	...
	BITTY_PROPERTY_READONLY(std::string, generic_Fill)
	...
	BITTY_PROPERTY_READONLY(std::string, menuEdit_FineZooming)
	...
	BITTY_PROPERTY_READONLY(std::string, menuProject_CopyCode)
	BITTY_PROPERTY_READONLY(std::string, menuProject_CopyCode_Requiring)
	BITTY_PROPERTY_READONLY(std::string, menuProject_CopyCode_LoadingResource)
	BITTY_PROPERTY_READONLY(std::string, menuProject_CopyCode_LoadingResourceAsMusic)
	BITTY_PROPERTY_READONLY(std::string, menuProject_CopyCode_LoadingResourceAsSfx)
	BITTY_PROPERTY_READONLY(std::string, menuProject_CopyCode_LoadingContent)
	...
	BITTY_PROPERTY_READONLY(std::string, menuProject_ExpandAll)
	BITTY_PROPERTY_READONLY(std::string, menuProject_CollapseAll)
	BITTY_PROPERTY_READONLY(std::string, menuProject_Reload)
	BITTY_PROPERTY_READONLY(std::string, menuProject_ReloadProject)
	...
	BITTY_PROPERTY_READONLY(std::string, dialogPrompt_CannotRenameAsset)
	...
	BITTY_PROPERTY_READONLY(std::string, dialogPrompt_Filling)
	...
	BITTY_PROPERTY_READONLY(std::string, dialogPrompt_InvalidPath)
	...
	BITTY_PROPERTY_READONLY(std::string, dialogPrompt_Repeat)
	...
	BITTY_PROPERTY_READONLY(std::string, windowPreferences_Editor_CorrectYZMapping)
	...
	BITTY_PROPERTY_READONLY(std::string, windowPreferences_Editor_Log)
	BITTY_PROPERTY_READONLY(std::string, windowPreferences_Editor_LogFilePath)
	BITTY_PROPERTY_READONLY(std::string, windowPreferences_Editor_LogToFile)
	...
	BITTY_PROPERTY_READONLY(std::string, windowPreferences_Editor_Shortcuts)
