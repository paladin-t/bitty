			...
			while (!file->endOfStream()) {
				...
				if (parts.size() >= 1) {
					constexpr const char* const TYPES[] = {
						...
						ARCHIVE_MP3_MEDIA_TYPE, ARCHIVE_OGG_MEDIA_TYPE, ARCHIVE_WAV_MEDIA_TYPE, ARCHIVE_MID_MEDIA_TYPE, ARCHIVE_AIFF_MEDIA_TYPE, ARCHIVE_VOC_MEDIA_TYPE, ARCHIVE_MOD_MEDIA_TYPE, ARCHIVE_OPUS_MEDIA_TYPE, ARCHIVE_FLAC_MEDIA_TYPE,
