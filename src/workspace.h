...
#ifndef WORKSPACE_OPTION_RENDERER_EFFECTS_DISABLED_KEY
#	define WORKSPACE_OPTION_RENDERER_EFFECTS_DISABLED_KEY "e"
#endif /* WORKSPACE_OPTION_RENDERER_EFFECTS_DISABLED_KEY */
